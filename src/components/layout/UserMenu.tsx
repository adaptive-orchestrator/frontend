...
import { Info, LogOut, Moon, Settings, Sun, User, Shield } from 'lucide-react';
        ...
        <div className="relative" ref={menuRef}>
            ...
            >
                ...
                <div className="py-1">
                    ...
                    {isAdmin && (
                        <button
                            onClick={() => handleNavigation(`${baseURL}admin`)}
                            className="flex items-center w-full px-6 py-3 text-sm text-left text-purple-700 cursor-pointer dark:text-purple-400 hover:bg-purple-50 dark:hover:bg-purple-900/20 border-l-4 border-purple-500"
                        >
