                ...
                <div className="bg-gradient-to-br from-blue-500 to-purple-600 p-1 rounded-2xl shadow-xl">
                  <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl">
                    ...
                    <p className="text-gray-600 dark:text-gray-300 mb-4">
                      The project focuses on building an AI-integrated microservices system that allows
                      enterprises to flexibly switch or combine multiple business models such as retail,
                      services, and subscriptions. By leveraging AI as an “orchestration assistant,” the
                      system can interpret natural language requirements, generate configuration changes,
                      and ensure safe deployment through strategies like canary and blue-green rollout.
                    </p>
                    <p className="text-gray-600 dark:text-gray-300 mb-4">
                      Beyond core microservices, the system introduces automated validation, monitoring,
                      and anomaly detection with reinforcement learning and autoencoders, enabling
                      self-healing capabilities. This ensures reduced manual effort, improved adaptability,
                      and higher reliability for modern enterprise operations.
                    </p>
